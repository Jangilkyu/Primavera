...
<html lang="en">
  ...
  <body>
	     <div class="black-background">  
	        <div class="white-backgrounds" style="width: 50%">
	  	...
	  	<div class="nav-container">
		       <p class="menu-logo"><a href="http://localhost:8080/ChungChunPrj/index.jsp">Primavera</a></p>
		       <span style="flex-grow: 10"></span>
		       <span class="menu-item"><a type="button" id="login">로그인</a></span>
		       <span class="menu-item"><a type="button" id="a" href="http://localhost:8080/ChungChunPrj/join.jsp">회원가입</a></span>
		...
		<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img src="http://localhost:8080/ChungChunPrj/img/img1.jpg"  class="d-block w-100 slide-img" alt="...">
